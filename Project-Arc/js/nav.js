 ...
 * persisting the active tab to appState, and Pass 8 mobile navigation.
 */
 ...
 *
 * @param {string} view - One of: today | calories | plan | recipes | grocery | progress | gym | goals
 */
...
(function initPass8MobileNavigation() {
  ...
  function ensureStylesheet() {
    if (document.querySelector('link[data-pass8-mobile-nav]')) return;
    const link = document.createElement('link');
    link.rel = 'stylesheet';
    link.href = 'css/nav-mobile-pass8.css';
    link.dataset.pass8MobileNav = 'true';
